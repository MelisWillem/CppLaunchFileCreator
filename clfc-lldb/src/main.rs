...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    if args.len() > 1 && (&args[1] == "--help" || &args[1] == "-h" || &args[1] == "-help") {
        println!("cpp launch file creator:\n Outputs launch.json file (to put in .vscode, and is consumed by codelldb extension) to run a command line throught lldb. The equivalent of 'lldb --args a.out arg1 arg2 arg3' . \n {EXAMPLE_CMD}");
        return Ok(());
    }
